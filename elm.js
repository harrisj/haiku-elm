...
var _user$project$Haiku$httpErrorToMessage = function (error) {
	var _p1 = error;
	switch (_p1.ctor) {
		case 'BadStatus':
...
var _user$project$Haiku$fetchSyllableCounts = F2(
	function (msg, url) {
		return A2(
...
var _user$project$Haiku$LoadTerms = function (a) {
	return {ctor: 'LoadTerms', _0: a};
};
var _user$project$Haiku$loadDict = A2(_user$project$Haiku$fetchSyllableCounts, _user$project$Haiku$LoadTerms, _user$project$Haiku$dictUrl);
