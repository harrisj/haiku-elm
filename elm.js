...
var _user$project$Haiku$viewAlert = F2(
...
var _user$project$Haiku$viewHeader = function (title) {
	return A2(
...
var _user$project$Haiku$maybeSum = F2(
	function (a, b) {
		return A3(
			_elm_lang$core$Maybe$map2,
			F2(
...
var _user$project$Haiku$syllableCountForTokens = F2(
	function (model, terms) {
		return A3(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Haiku$syllablesForTerm(model),
				A2(
					_elm_lang$core$List$map,
					function (_) {
						return _.normalized;
...
var _user$project$Haiku$viewLineStatus = F2(
	function (model, line) {
...
var _user$project$Haiku$initialHaiku = {
	line0: _elm_lang$core$Native_Utils.update(
		_user$project$Haiku$initialLine,
		{syllables: 5}),
	line1: _elm_lang$core$Native_Utils.update(
		_user$project$Haiku$initialLine,
		{syllables: 7}),
	line2: _elm_lang$core$Native_Utils.update(
		_user$project$Haiku$initialLine,
		{syllables: 5})
};
var _user$project$Haiku$initialModel = {
	haiku: _user$project$Haiku$initialHaiku,
	syllables: _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'the', _1: 1},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'rain', _1: 1},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'falls', _1: 1},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'down', _1: 1},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'softly', _1: 2},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Haiku$normalizedTermsForLine = F2(
	function (model, lineNum) {
		var line = A2(_user$project$Haiku$getHaikuLine, model.haiku, lineNum);
		var terms = line.terms;
		return A2(
			_elm_lang$core$List$map,
			function (_) {
...
var _user$project$Haiku$normalizedTerms = function (model) {
	return _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: A2(_user$project$Haiku$normalizedTermsForLine, model, 0),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Haiku$normalizedTermsForLine, model, 1),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Haiku$normalizedTermsForLine, model, 2),
					_1: {ctor: '[]'}
				}
			}
		});
				...
				if (_p4.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								syllables: A3(_elm_lang$core$Dict$insert, _p3._0, _p4._0, model.syllables)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ClearSyllableCount':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							syllables: A2(_elm_lang$core$Dict$remove, _p3._0, model.syllables)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'EditLine':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Haiku$setEditLine, model, _p3._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SaveLineText':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Haiku$saveLineText, model, _p3._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CancelLineText':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Haiku$cancelTempLineText, model, _p3._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'EnterTempLineText':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Haiku$saveTempLineText, model, _p3._0, _p3._1),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Haiku$viewLine = F2(
	function (model, lineNum) {
		...
		var _p6 = line.lineState;
		if (_p6.ctor === 'EnterText') {
			return A2(
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Haiku$viewLine, model, 0),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Haiku$viewLine, model, 1),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Haiku$viewLine, model, 2),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Haiku$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Haiku$viewHeader('Haiku Maker'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Haiku$viewAlert, _user$project$Haiku$CloseAlert, model.alertMessage),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('row debug'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Haiku$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Haiku$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
...
var _user$project$Haiku$NewHaiku = {ctor: 'NewHaiku'};

var Elm = {};
Elm['Haiku'] = Elm['Haiku'] || {};
if (typeof _user$project$Haiku$main !== 'undefined') {
    _user$project$Haiku$main(Elm['Haiku'], 'Haiku', undefined);
}
